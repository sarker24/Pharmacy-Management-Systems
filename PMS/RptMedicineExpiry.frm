...
Begin VB.Form RptMedicineExpiry 
   BackColor       =   &H00C0B4A9&
   ...
   ClientTop       =   930
   ClientWidth     =   6360
   Icon            =   "RptMedicineExpiry.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptMedicineExpiry.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptMedicineExpiry.frx":0E64
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptMedicineExpiry.frx":173E
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackColor       =   &H00808000&
      Caption         =   "Medicine Expiry Report"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptMedicineExpiry"
...
Dim rsTemp2 As New ADODB.Recordset
    ...
    While Not rsTemp2.EOF
        cmbItemName.AddItem rsTemp2("MedicineName")
        rsTemp2.MoveNext
    Wend
    rsTemp2.Close
...
'     dcCatagory.RecordSource = "SELECT DISTINCT MedicineName as MedicineName FROM tblMedicineName ORDER BY MedicineName"
'     cmbItemName.DataMode = ssDataModeBound
'     Set cmbItemName.DataSource = dcCatagory
'     cmbItemName.DataSourceList = dcCatagory
'     cmbItemName.DataFieldList = "MedicineName"
'     cmbItemName.DataField = "MedicineName"
'     cmbItemName.ColumnHeaders = True
'     cmbItemName.BackColorEven = &HFFC0C0
'     cmbItemName.ForeColorEven = &H80000008
'     cmbItemName.Columns(0).Width = TextHeight("W") * 10
End Sub
...
Public Function FetchData()
    ...
    rsMaster.Open "SELECT p.SerialNo, p.Sname, p.Catagory,p.Mname, p.Qty, " & _
                   "P.PRate , P.Amount, P.DateM, P.DateExp " & _
                   "FROM PurchaseDetail p WHERE " & _
                   "P.DateExp='" & SSCurrentDate.Value & "'", cn, adOpenStatic, adLockReadOnly
 ...
 rsMaster.Open "SELECT p.SerialNo, p.Sname, p.Catagory,p.Mname, p.Qty, " & _
                   "P.PRate , P.Amount, P.DateM, P.DateExp " & _
                   "FROM PurchaseDetail p WHERE " & _
                   "P.DateExp BETWEEN '" & SSFDate.Value & "'AND '" & SSTDate.Value & "'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Medicine Expiry.rpt"
