...
'            rsTemp.CursorLocation = adUseClient
     rsTemp.Open "SELECT SerialNo,UID,UName,Password,Privilegegroup " & _
                 "FROM PMSUser WHERE PMSUser.UName LIKE '" & txtSearch.text & "%'", cn, adOpenStatic, adLockReadOnly
...
'   End If
    ...
    While Not rsTemp.EOF
        fgExport.AddItem "" & vbTab & rsTemp("SerialNo") & vbTab & rsTemp("UID") & vbTab & rsTemp("UName") & vbTab & rsTemp("Password") & _
...
'            rsTemp.CursorLocation = adUseClient
     rsTemp.Open "SELECT SerialNo,UID,UName,Password,Privilegegroup FROM PMSUser", cn, adOpenStatic, adLockReadOnly
...
'   End If
    ...
    While Not rsTemp.EOF
        fgExport.AddItem "" & vbTab & rsTemp("SerialNo") & vbTab & rsTemp("UID") & vbTab & rsTemp("UName") & _
         vbTab & rsTemp("Password") & vbTab & rsTemp("Privilegegroup")
...
Private Sub PopulateCompanySearch()
        ...
        frmUser.PopulateCnf fgExport.TextMatrix(fgExport.Row, 1)
        End If
    End Sub
