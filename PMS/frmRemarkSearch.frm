...
Begin VB.Form frmRemarkSearch 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Remark Search"
   ClientHeight    =   4665
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5265
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H00C0B4A9&
      Caption         =   "Medicine Remarks Details"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
      ...
      Begin VSFlex7LCtl.VSFlexGrid fgExport 
         ...
         FormatString    =   $"frmRemarkSearch.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmRemarkSearch"
...
'            rsTemp.CursorLocation = adUseClient
     rsTemp.Open "SELECT RID,Remarks " & _
                 "FROM tblRemarks WHERE tblRemarks.Remarks LIKE '" & txtSearch.text & "%'", cn, adOpenStatic, adLockReadOnly
...
'   End If
    ...
    While Not rsTemp.EOF
        fgExport.AddItem "" & vbTab & rsTemp("RID") & vbTab & rsTemp("Remarks")
...
Private Sub cmdOk_Click()
    If fgExport.RowSel < 0 Then
        MsgBox "Please Select a Medicine Remarks From the List."
        Exit Sub
    End If
...
'            rsTemp.CursorLocation = adUseClient
     rsTemp.Open "SELECT RID,Remarks FROM tblRemarks", cn, adOpenStatic, adLockReadOnly
...
End Sub
    ...
    Private Sub PopulateCompanySearch()
        If fgExport.Row > 0 Then
             ...
             frmMedicineRemarks.PopulatetblRemarks fgExport.TextMatrix(fgExport.Row, 1)
        End If
    End Sub
