...
Begin VB.Form RptIStatement 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Medicine Item wise Statement"
   ClientHeight    =   4200
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6300
   Icon            =   "RptIStatement.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4200
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label2 
         ...
         Width           =   2055
      End
      Begin MSForms.ComboBox cmbMName 
         Height          =   375
         Left            =   2160
         TabIndex        =   11
         Top             =   240
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptIStatement.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptIStatement.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptIStatement.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00000000&
      Caption         =   "Medicine Item Purchase Report"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptIStatement"
...
Private Sub MName()
    ...
    While Not rsTemp2.EOF
        cmbMName.AddItem rsTemp2("MedicineName")
        rsTemp2.MoveNext
    Wend
    rsTemp2.Close
End Sub
...
Public Function FetchData()
    ...
    rsMaster.Open "SELECT     SerialNo, Sname, Pdate, SbillNo, MCatagory, Mname, " & _
                    ...
                    "WHERE    Pdate='" & CurrentDate.Value & "' AND Posted = 'Posted' and PurchaseDetail.Mname='" & parseQuotes(cmbMName) & "'", cn, adOpenStatic, adLockReadOnly
     ...
     rsMaster.Open "SELECT     SerialNo, Sname, Pdate, SbillNo, MCatagory, Mname, " & _
                    ...
                    "'" & TDate.Value & "' AND Posted = 'Posted' and PurchaseDetail.Mname='" & parseQuotes(cmbMName) & "'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Medicine Purchase Statement.rpt"
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Medicine Purchase Statement All.rpt"
        Set objReportApp = CreateObject("Crystal.CRPE.Application")
        Set objReport = objReportApp.OpenReport(strPath)
        Set objReportDatabase = objReport.Database
        Set objReportDatabaseTables = objReportDatabase.Tables
...
'             objReportFF.text = "'" + Format(DTPTo, "dd-MMM-yyyy") + "'"
        ...
        objReport.DiscardSavedData
        objReport.Preview "Medicine Purchase Statement Report", , , , , 16777216 Or 524288 Or 65536
