...
Begin VB.Form RptSalesReturn 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSalesReturn.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSalesReturn.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSalesReturn.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackColor       =   &H00808000&
      Caption         =   "Medicine Sales Return Statement"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptSalesReturn"
...
Public Function FetchData1()
    ...
    If OpCurrentDate.Value = True Then
      ...
      rsMaster.Open "SELECT CMID, SName, MCatagory, MName, Qty, SRate, Amount, PRate, Discount, Posted, UName, SDate " & _
                    "From SalesDetail " & _
                    "WHERE (Qty < 0)and SDate='" & CurrentDate.Value & "' AND Posted = 'Posted' order by CMID", cn, adOpenStatic, adLockReadOnly
     ...
     End If
      ...
      rsMaster.Open "SELECT CMID, SName, MCatagory, MName, Qty, SRate, Amount, PRate, Discount, Posted, UName, SDate " & _
                    "From SalesDetail " & _
                    "WHERE (Qty<0) and SDate BETWEEN '" & FDate.Value & "' AND " & _
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Sales Return.rpt"
 ...
 If OpCurrentDate.Value = True Then
  ...
  If OpCustomDate.Value = True Then
   ...
   End If
        ...
        objReport.Preview "Sales Return Informations", , , , , 16777216 Or 524288 Or 65536
...
ErrH:
    ...
    Select Case Err.Number
        Case 20545
            MsgBox "Request cancelled by the user", vbInformation, "Sales Return Report"
        Case Else
            MsgBox "Error " & Err.Number & " - " & Err.Description, vbCritical, "Sales Return Report"
    End Select
End Sub
...
Public Function FetchData()
    ...
    If OpCurrentDate.Value = True Then
     ...
     rsMaster.Open "SELECT CMID, SName, MCatagory, MName, Qty, SRate, Amount, PRate, Discount, Posted, UName, SDate " & _
                    "From SalesDetail " & _
                    "WHERE (Qty < 0)and Sdate='" & CurrentDate.Value & "' AND Posted = 'Posted' and SalesDetail.MName='" & parseQuotes(cmbMName) & "'", cn, adOpenStatic, adLockReadOnly
  ...
  rsMaster.Open "SELECT CMID, SName, MCatagory, MName, Qty, SRate, Amount, PRate, Discount, Posted, UName, SDate " & _
                    "From SalesDetail " & _
                    "WHERE (Qty<0) and Sdate BETWEEN '" & FDate.Value & "' AND " & _
                    "'" & TDate.Value & "' AND Posted = 'Posted' and SalesDetail.MName='" & parseQuotes(cmbMName) & "'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Sales Return Details.rpt"
        Set objReportApp = CreateObject("Crystal.CRPE.Application")
        Set objReport = objReportApp.OpenReport(strPath)
        Set objReportDatabase = objReport.Database
        Set objReportDatabaseTables = objReportDatabase.Tables
