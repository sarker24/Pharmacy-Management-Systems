...
Begin VB.Form frmStockMasterSearch 
   BackColor       =   &H00C0B4A9&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Stock Details Information"
   ClientHeight    =   2475
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6615
   Icon            =   "frmStockMasterSearch.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2475
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmStockMasterSearch.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmStockMasterSearch.frx":0E64
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmStockMasterSearch.frx":173E
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00000000&
      Caption         =   "Medicine Current Stock Report Details"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmStockMasterSearch"
...
'       rsEmp.Open "exec Stock_Status2 '" & SSFDate & "', '" & SSTDate & "'", cn, adOpenStatic, adLockReadOnly
        rsEmp.Open "exec Stock_Status2 '" & SSFDate.Value & "', '" & SSTDate.Value & "'", cn, adOpenStatic, adLockReadOnly
...
'    On Error GoTo errh
    ...
    strPath = App.Path + "\reports\Stock Position Date.rpt"
