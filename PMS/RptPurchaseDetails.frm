...
Begin VB.Form RptPurchaseDetails 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Purchase Details Statement"
   ClientHeight    =   4170
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6285
   Icon            =   "RptPurchaseDetails.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4170
   ScaleWidth      =   6285
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptPurchaseDetails.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptPurchaseDetails.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptPurchaseDetails.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00000000&
      Caption         =   " Purchase Report Details"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptPurchaseDetails"
...
Public Function FetchData()
    ...
    rsMaster.Open "SELECT     SerialNo, Sname, Pdate, SbillNo, MCatagory, Mname, " & _
                    ...
                    "WHERE    Pdate='" & CurrentDate.Value & "' AND Posted = 'Posted' and PurchaseDetail.Sname='" & parseQuotes(cmbSName) & "'", cn, adOpenStatic, adLockReadOnly
     ...
     rsMaster.Open "SELECT     SerialNo, Sname, Pdate, SbillNo, MCatagory, Mname, " & _
                    ...
                    "'" & TDate.Value & "' AND Posted = 'Posted' and PurchaseDetail.Sname='" & parseQuotes(cmbSName) & "'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Purchase All Details.rpt"
