...
Begin VB.Form RptSalesSummery 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSalesSummery.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSalesSummery.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSalesSummery.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00000000&
      Caption         =   "Catagory and Item wise Sales Report"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   18
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptSalesSummery"
...
Dim rsTemp2 As New ADODB.Recordset
    ...
    While Not rsTemp2.EOF
        cmbSName.AddItem rsTemp2("MCatagory")
        rsTemp2.MoveNext
    Wend
    rsTemp2.Close
...
Public Function FetchData()
    ...
    rsMaster.Open "SELECT  SerialNo,CMID, SName,MCatagory, MName, Qty, SRate, Amount,PRate, Discount,(Amount * Discount / 100) AS TDiscount, (Amount - (Amount * Discount / 100)) AS NetAmount, Posted, UName, SDate " & _
                    "From SalesDetail " & _
                    "WHERE    SDate='" & CurrentDate.Value & "' AND Posted = 'Posted' and SalesDetail.MCatagory='" & parseQuotes(cmbSName) & "'", cn, adOpenStatic, adLockReadOnly
     ...
     rsMaster.Open "SELECT SerialNo,CMID,SName, MCatagory, MName, Qty, SRate, Amount,PRate, Discount,(Amount * Discount / 100) AS TDiscount, (Amount - (Amount * Discount / 100)) AS NetAmount, Posted, UName, SDate " & _
                    ...
                    "'" & TDate.Value & "' AND Posted = 'Posted' and SalesDetail.MCatagory='" & parseQuotes(cmbSName) & "'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\PL Catagory Sales Statement.rpt"
...
'Dim rsTemp2 As New ADODB.Recordset
'
'     rsTemp2.Open ("SELECT DISTINCT CatagoryName FROM MedicineCatagory ORDER BY CatagoryName ASC"), cn, adOpenStatic
'
'    While Not rsTemp2.EOF
'        cmbMCatagory.AddItem rsTemp2("CatagoryName")
'        rsTemp2.MoveNext
'    Wend
'    rsTemp2.Close
'
...
'
'
'    rsMaster.Open "SELECT     CMID,Tamount,DiscuntPer, DiscuntTaka, Tpaid,  " & _
...
''
''
'' rsMaster.Open "SELECT  MCatagory,MName, " & _
''                    "sum(Qty)as Quentity,Rate,(sum(Qty)*Rate) as amount,posted " & _
''                    "From SalesDetail where SDate ='" & SSCurrentDate.Value & "' AND Posted = 'Posted'" & _
''                    "GROUP BY MCatagory,MName,Rate,posted", cn, adOpenStatic, adLockReadOnly
''
''
''       End If
''
...
'' rsMaster.Open "SELECT  MCatagory,MName, " & _
''                    "sum(Qty)as Quentity,Rate,(sum(Qty)*Rate) as amount,posted " & _
''                    "From SalesDetail where SDate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "' and Posted = 'Posted'" & _
''                    "GROUP BY MCatagory,MName,Rate,posted", cn, adOpenStatic, adLockReadOnly
''     End If
'
'End Function
...
'
'
''        strPath = App.Path + "\reports\Sales Summery Statement.rpt"
'         strPath = App.Path + "\reports\Medicine Sales Summary.rpt"
'        Set objReportApp = CreateObject("Crystal.CRPE.Application")
'        Set objReport = objReportApp.OpenReport(strPath)
'        Set objReportDatabase = objReport.Database
'        Set objReportDatabaseTables = objReportDatabase.Tables
...
'
'   Set objReportFF = objReportFormulaFieldDefinations.Item(1)
'              objReportFF.text = "'" + Format(SSCurrentDate, "dd-MM-yyyy") + "'"
'
'   Set objReportFF = objReportFormulaFieldDefinations.Item(4)
...
'   Set objReportFF = objReportFormulaFieldDefinations.Item(2)
'
'              objReportFF.text = "'" + Format(SSFDate, "dd-MM-yyyy") + "'"
'
'   Set objReportFF = objReportFormulaFieldDefinations.Item(3)
'             objReportFF.text = "'" + Format(SSTDate, "dd-MM-yyyy") + "'"
'
'   Set objReportFF = objReportFormulaFieldDefinations.Item(4)
'              objReportFF.text = "'" + cmbMCatagory + "'"
'
...
'
'        objReport.DiscardSavedData
'        objReport.Preview "Medicine Sales Summery Insformations", , , , , 16777216 Or 524288 Or 65536
'
'
'     If Tracer = 1 Then
'    objReport.PrintOut
...
'    Select Case Err.Number
'        Case 20545
'            MsgBox "Request cancelled by the user", vbInformation, "Medicine Sales Summery Statement"
'        Case Else
'            MsgBox "Error " & Err.Number & " - " & Err.Description, vbCritical, "Medicine Sales Summery Statement"
'    End Select
'End Sub
'
'
