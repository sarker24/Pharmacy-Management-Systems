...
Begin VB.Form RptOPDPatientDue 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Outdoor Patient Due Statement"
   ClientHeight    =   4125
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6315
   Icon            =   "RptOPDPatientDue.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   4125
   ScaleWidth      =   6315
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptOPDPatientDue.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptOPDPatientDue.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptOPDPatientDue.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label58 
      ...
      Caption         =   "Indoor/Outdoor Medicine Due  Statement"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   15.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptOPDPatientDue"
...
Private Sub EmployeeName()
     ...
     rsTemp.Open ("SELECT DISTINCT RegNo FROM PRegtration ORDER BY RegNo DESC"), cn, adOpenStatic

    While Not rsTemp.EOF
        cmbEName.AddItem rsTemp("RegNo")
        rsTemp.MoveNext
    Wend
    rsTemp.Close
...
Set rsMaster = New ADODB.Recordset
    ...
    rsMaster.Open "SELECT  CMID, SDate, CName, CAddress, RegNo,BedNo, Tamount, DiscuntPer, DiscuntTaka, Ttime, Tpaid, Tdue, Advance, Posted, UName, Admitted, Remark " & _
                    "From SalesMaster " & _
                    "WHERE SDate='" & CurrentDate.Value & "' AND Posted = 'Posted' and SalesMaster.RegNo='" & parseQuotes(cmbEName) & "'", cn, adOpenStatic, adLockReadOnly
     ...
     rsMaster.Open "SELECT CMID, SDate, CName, CAddress, RegNo,BedNo, Tamount, DiscuntPer, DiscuntTaka, Ttime, Tpaid, Tdue, Advance, Posted, UName, Admitted, Remark " & _
                    ...
                    "'" & TDate.Value & "' AND Posted = 'Posted' and SalesMaster.RegNo='" & parseQuotes(cmbEName) & "'", cn, adOpenStatic, adLockReadOnly
...
Public Function FetchData1()
    ...
    rsMaster.Open "SELECT CMID,SDate,CName,CAddress,RegNo,BedNo,Tamount,DiscuntPer, DiscuntTaka, Ttime,Tpaid, " & _
                  "TDue, Advance,Posted, UName,Admitted " & _
                  "From SalesMaster " & _
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Sales Due Statement Patient.rpt"
 ...
 If OpCurrentDate.Value = True Then
  ...
  If OpCustomDate.Value = True Then
   ...
   End If
        ...
        objReport.Preview "Indoor Patients Due Statement", , , , , 16777216 Or 524288 Or 65536
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Sales Due Statement Summary.rpt"
        Set objReportApp = CreateObject("Crystal.CRPE.Application")
        Set objReport = objReportApp.OpenReport(strPath)
        Set objReportDatabase = objReport.Database
        Set objReportDatabaseTables = objReportDatabase.Tables
...
If OpCurrentDate.Value = True Then
  ...
  If OpCustomDate.Value = True Then
   ...
   End If
        ...
        objReport.DiscardSavedData
        objReport.Preview "All Patients Due Statement", , , , , 16777216 Or 524288 Or 65536
...
ErrH:
    ...
    Select Case Err.Number
        Case 20545
            MsgBox "Request cancelled by the user", vbInformation, "All Patients Due Statement"
        Case Else
            MsgBox "Error " & Err.Number & " - " & Err.Description, vbCritical, "All Patients Due Statement"
    End Select
End Sub
