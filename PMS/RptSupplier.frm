...
Begin VB.Form RptSupplierLedger 
   BackColor       =   &H00C0B4A9&
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSupplier.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSupplier.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSupplier.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "RptSupplierLedger"
...
Private rsTemp2                             As New ADODB.Recordset
...
Private Sub CatagoryName()
   Dim rsTemp2 As New ADODB.Recordset
    ...
    While Not rsTemp2.EOF
        cmbItemName.AddItem rsTemp2("SupplierName")
        rsTemp2.MoveNext
    Wend
    rsTemp2.Close
End Sub
...
Public Function FetchData()
 ...
 rsMaster.Open "SELECT  Sname,Catagory,MName, " & _
                    "sum(Qty)as Quentity,PRate,(sum(Qty)*PRate) as amount,posted " & _
                    "From PurchaseDetail where Pdate ='" & SSCurrentDate.Value & "' AND Posted = 'Posted'" & _
                    "GROUP BY Sname,Catagory,MName,PRate,posted", cn, adOpenStatic, adLockReadOnly
 ...
 rsMaster.Open "SELECT  Sname,Catagory,MName, " & _
                    "sum(Qty)as Quentity,PRate,(sum(Qty)*PRate) as amount,posted " & _
                    "From PurchaseDetail where Pdate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "' and Posted = 'Posted'" & _
                    "GROUP BY Sname,Catagory,MName,PRate,posted", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Supplier Purchase Summery.rpt"
   ...
   Set objReportFF = objReportFormulaFieldDefinations.Item(1)
        ...
        objReport.Preview "Supplier wise Purchase Report", , , , , 16777216 Or 524288 Or 65536
